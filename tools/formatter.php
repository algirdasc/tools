...
<div class="h-100 border cm-full-height" style="position: relative;">
   <textarea id="formatter-code-input" class="form-control align-self-stretch">
        <?= $activeSnippet && isset($activeSnippet['snippetLeft']) ? htmlspecialchars($activeSnippet['snippetLeft'], ENT_QUOTES, 'UTF-8') : '' ?>
    </textarea>
</div>
<div>
   <hr />
